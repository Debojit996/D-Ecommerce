...
// After Login the token genarate and get in to the home page
let responseData;
...
const signup = async ()=>{
  ...
  // After signup the token genarate and get in to the home page
  let responseData;
  ...
  return (
    <div className='logingsignup'>
        <div className="loginsignup-container">
          ...
          {/* if already signup then get login page either signup page */}
